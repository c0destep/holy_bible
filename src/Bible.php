...
class Bible
{
    ...
    {
        return $this->getContentApi(
            'verses/' . $this->version . DIRECTORY_SEPARATOR . $book->value . DIRECTORY_SEPARATOR . $chapter
        );
    }
    ...
    {
        return $this->getContentApi(
            'verses/' . $this->version . DIRECTORY_SEPARATOR . $book->value . DIRECTORY_SEPARATOR . $chapter . DIRECTORY_SEPARATOR . $verse
        );
    }
}
